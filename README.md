...
Currently 41 libraries are successfully benchmarked. They are listed in alphabetic order:
...
[taocpp/json](https://github.com/taocpp/json) | C++11 | 1.0.0-beta.4 | Uses [PEGTL](https://github.com/ColinH/PEGTL) for parsing
